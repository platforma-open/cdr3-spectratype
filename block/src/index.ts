...
import { platforma } from "@platforma-open/milaboratories.cdr3-spectratype.model";
import {
  InferOutputsType,
  InferDataType,
  InferHrefType,
...
export type Cdr3SpectratypeBlockContract = BlockContract;
export type Cdr3SpectratypeBlockOutputs  = BlockOutputs;
export type Cdr3SpectratypeBlockData     = BlockData;
export const Cdr3SpectratypeBlockPointer = BlockPointer;
