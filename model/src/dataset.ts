...
/**
 * Whether the dataset's key axis is a receptor record this block can compute spectratypes on.
 *
 ...
 * only on the columns, so the axis alone cannot answer. The probe reads the CDR3 sequence
